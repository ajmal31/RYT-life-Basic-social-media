...
export const login = async (req, res) => {
  try {
    ...
    // Store the token in the DB to ensure the user is logged in from only one browser at a time
...
export const uploadProfilePicture = async (req, res) => {
  try {
    ...
    const profilePictureUpdated = await userHelper.updateUserFeilds(
      _id,
      key,
      url
    );
